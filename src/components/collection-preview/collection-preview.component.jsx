    ...
    <div className='collection-preview'>
        {
            (() => {
                ...
                collectionsNowShowing = collectionsNowShowing.filter((collection, idx) => collection.Year<2023);
                collectionsPopular = collectionsPopular.filter((collection, idx) => collection.Year<2023);
                let collectionsUpcoming = [...collections].filter((collection, idx) => collection.Year >= 2023);
